...
public class Product {
    ...
    public Product(UUID id, String name, String description, BigDecimal price, String imageUrl, Integer stockLevel) {
        this.id = id;
        this.name = name;
